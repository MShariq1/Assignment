...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/M.Shariq Hasnain/Networking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'M.Shariq Hasnain' => 'shariqh311@gmail.com' }
  s.source           = { :git => 'https://github.com/M.Shariq Hasnain/Networking.git', :tag => s.version.to_s }
  ...
  s.resources = 'Networking/Module/**/*.{xcasssets,json,storyboard,xib,xcdatamodeld}'
